...
if __name__ == '__main__':
    ...
    from hd_nanpy import convenyor

    thr1 = Thread(target=detect_fish, args=["0", 
    ["yolov7_3200.pt"],False,False,640,False,False,'runs/detect',"ex",False,'',
    False,0.25,0.45,None,False,False])
    
    thr2 = Thread(target=convenyor)
